...
func (s Server) domainPackagesHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainPackages), map[string]interface{}{
		"User":     u,
		"Domain":   pkgs.Domain,
		"Domains":  domains,
...
func (s Server) domainAddHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainAdd), map[string]interface{}{
		"User":       u,
		"Domain":     domain,
		"DomainName": s.Domain,
	})
...
func (s Server) domainChangelogHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainChangelog), map[string]interface{}{
		"User":             u,
		"Domain":           domain,
		"Domains":          domains,
...
func (s Server) domainTeamHandler(w http.ResponseWriter, r *http.Request) {
	...
	if domain.OwnerUserID != u.ID {
		respond(w, s.template(tidDomainTeam), map[string]interface{}{
			"Forbidden": true,
			"User":      u,
			"Domain":    domain,
			"Domains":   domains,
...
func (s Server) domainSettingsHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainSettings), map[string]interface{}{
...
func (s Server) domainDomainUserGrantHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainUserGrant), map[string]interface{}{
		"User":    u,
		"Domain":  domain,
		"Domains": domains,
	})
...
func (s Server) domainDomainUserRevokeHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainUserRevoke), map[string]interface{}{
		"User":       u,
		"Domain":     domain,
		"Domains":    domains,
...
func (s Server) domainDomainOwnerChangeHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainOwnerChange), map[string]interface{}{
		"User":    u,
		"Domain":  domain,
		"Domains": domains,
	})
...
func (s Server) domainPackageEditHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidDomainPackageEdit), map[string]interface{}{
		"User":     u,
		"Domain":   domain,
		"Domains":  domains,
		"Package":  pkg,
...
func (s Server) userPageHandler(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, s.template(tidUserPage), map[string]interface{}{
		"User":     u,
		"PageUser": pu,
	})
}
